...
class InvitationApi extends Api
{
     ...
     * @param null|\DateTime $sendProductAt When to send the product review invite at. Note this must be after to send at.
    ...
    public function products(
        ...
        ?\DateTimeInterface $sendProductAt = null,
        ...
        if ($sendProductAt == null) {
            $sendProductAt = $sendAt == null ? CarbonImmutable::now()->subDay() : CarbonImmutable::parse($sendAt)->addDay();
        }
