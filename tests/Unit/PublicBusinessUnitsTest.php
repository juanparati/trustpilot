...
namespace Juanparati\Trustpilot\Tests\Unit;

use Juanparati\Trustpilot\Tests\TestBase;
...
class PublicBusinessUnitsTest extends TestBase
{
     ...
     * Trustpilot BUID
     */
    protected const TRUSPILOT_DOMAIN = 'trustpilot.com';
    protected const TRUSTPILOT_BUID = '46d6a890000064000500e0c3';
     ...
     * @return void
     */
    public function testSearchWithReviewsBusinessUnit(): void
    {
        $tp = $this->getInstance();
     ...
     * @return void
     */
    public function testSearchMultipleBusinessUnit(): void
    {
        $tp = $this->getInstance();
